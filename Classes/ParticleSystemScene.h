...
private:
	...
	cocos2d::ui::TextBMFont *_Emitter_TypeBMFont;
...
public:
	...
	void Emitter_TypeEvent(cocos2d::Ref* sender, cocos2d::ui::Slider::EventType type);
	//
	void BUBBLEbtnTouchEvent(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type);
	void CIRCLEbtnTouchEvent(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type);
	void CLOUDbtnTouchEvent(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type);
	void COMETbtnTouchEvent(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type);
	void RAINDROPbtnTouchEvent(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type);
	void SPARKbtnTouchEvent(cocos2d::Ref *pSender, cocos2d::ui::Widget::TouchEventType type);
